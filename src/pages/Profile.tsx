...
export default function Profile() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("http://vladuvv-mangal-market-ee97.twc1.net/api/login", {
        method: "POST",
  ...
  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("http://vladuvv-mangal-market-ee97.twc1.net/api/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://vladuvv-mangal-market-ee97.twc1.net/api/profile", {
        method: "POST", 
        headers: { "Content-Type": "application/json" },
